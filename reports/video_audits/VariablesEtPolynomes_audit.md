...
Generated: 2026-05-16 20:51:22

## Executive Summary

- Scene: `scenes/variables_et_polynomes/variables_et_polynomes_scene.py`
...
1. **[AudioCaptionAgent] No SRT beside MP4**
   ...
   - Detail: `dist/VariablesEtPolynomes/VariablesEtPolynomes.srt` does not exist.
...
3. **[RenderMetadataAgent] Metadata summary**
   - Category: `render`
   - Location: `dist/VariablesEtPolynomes/VariablesEtPolynomes.mp4`
   - Detail: Duration 70.4s, resolution 854x480, frame rate 15.00 fps.
...
6. **[SourceScriptAgent] Manual narration pacing detected**
   - Category: `sync`
   - Location: `scenes/variables_et_polynomes/variables_et_polynomes_scene.py`
...
7. **[SourceScriptAgent] Scene class found**
   - Category: `source`
   - Location: `scenes/variables_et_polynomes/variables_et_polynomes_scene.py:192`
...
```bash
./.venv/bin/python -m py_compile scenes/variables_et_polynomes/variables_et_polynomes_scene.py
MANIM_DISABLE_VOICEOVER=1 ./scripts/render.sh scenes/variables_et_polynomes/variables_et_polynomes_scene.py VariablesEtPolynomes ql
./.venv/bin/python scripts/audit_video.py --scene scenes/variables_et_polynomes/variables_et_polynomes_scene.py --class VariablesEtPolynomes --video dist/VariablesEtPolynomes/VariablesEtPolynomes.mp4 --out reports/video_audits/VariablesEtPolynomes_audit.md --silent-preview
```
