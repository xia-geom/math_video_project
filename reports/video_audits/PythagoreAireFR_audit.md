...
Generated: 2026-07-31 00:11:12

## Executive Summary

- Scene: `scenes/geometrie_fr/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr_scene.py`
- Video: `dist/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr.mp4`
...
1. **[AudioCaptionAgent] Audio summary**
   - Category: `audio`
   - Location: `dist/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr.mp4`
   - Detail: Audio duration 84.4s, average -25.9 dBFS, peak -6.5 dBFS.
   - Fix: No action needed.

2. **[AudioCaptionAgent] SRT timing parsed**
   - Category: `captions`
   - Location: `dist/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr.srt`
...
5. **[SourceScriptAgent] Scene class found**
   - Category: `source`
   - Location: `scenes/geometrie_fr/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr_scene.py:65`
...
```bash
./.venv/bin/python -m py_compile scenes/geometrie_fr/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr_scene.py
MANIM_DISABLE_VOICEOVER=1 ./scripts/render.sh scenes/geometrie_fr/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr_scene.py PythagoreAireFR ql
./.venv/bin/python scripts/audit_video.py --scene scenes/geometrie_fr/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr_scene.py --class PythagoreAireFR --video dist/16_pythagore_par_les_aires_fr/16_pythagore_par_les_aires_fr.mp4 --out reports/video_audits/PythagoreAireFR_audit.md --silent-preview
```
