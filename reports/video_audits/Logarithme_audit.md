...
Generated: 2026-07-31 00:11:29

## Executive Summary

- Scene: `scenes/exponentielles_et_logarithmes_fr/14_logarithmes_fr/14_logarithmes_fr_scene.py`
- Video: `dist/14_logarithmes_fr/14_logarithmes_fr.mp4`
...
1. **[PedagogyAccessibilityAgent] Color-coded meaning should be double encoded**
   ...
   - Location: `scenes/exponentielles_et_logarithmes_fr/14_logarithmes_fr/14_logarithmes_fr_scene.py`
...
1. **[AudioCaptionAgent] Audio summary**
   - Category: `audio`
   - Location: `dist/14_logarithmes_fr/14_logarithmes_fr.mp4`
   - Detail: Audio duration 272.7s, average -25.7 dBFS, peak -6.6 dBFS.
   - Fix: No action needed.

2. **[AudioCaptionAgent] SRT timing parsed**
   - Category: `captions`
   - Location: `dist/14_logarithmes_fr/14_logarithmes_fr.srt`
...
3. **[RenderMetadataAgent] Metadata summary**
   - Category: `render`
   - Location: `dist/14_logarithmes_fr/14_logarithmes_fr.mp4`
   - Detail: Duration 272.7s, resolution 1920x1080, frame rate 60.00 fps.
   - Fix: No action needed.
...
6. **[SourceScriptAgent] Scene class found**
   - Category: `source`
   - Location: `scenes/exponentielles_et_logarithmes_fr/14_logarithmes_fr/14_logarithmes_fr_scene.py:36`
...
```bash
./.venv/bin/python -m py_compile scenes/exponentielles_et_logarithmes_fr/14_logarithmes_fr/14_logarithmes_fr_scene.py
MANIM_DISABLE_VOICEOVER=1 ./scripts/render.sh scenes/exponentielles_et_logarithmes_fr/14_logarithmes_fr/14_logarithmes_fr_scene.py Logarithme ql
./.venv/bin/python scripts/audit_video.py --scene scenes/exponentielles_et_logarithmes_fr/14_logarithmes_fr/14_logarithmes_fr_scene.py --class Logarithme --video dist/14_logarithmes_fr/14_logarithmes_fr.mp4 --out reports/video_audits/Logarithme_audit.md --silent-preview
```
