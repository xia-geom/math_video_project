# Video Audit: FunctionIntuitive

Generated: 2026-05-16 20:50:11

## Executive Summary

- Scene: `scenes/function_intuitive_fr/function_intuitive_scene.py`
- Video: `dist/FunctionIntuitive/FunctionIntuitive.mp4`
- Frame artifacts: `reports/video_audits/FunctionIntuitive_audit_frames`
- Silent preview mode: `True`
- Findings: 0 blocker, 1 warning, 0 polish, 8 info.
...
1. **[AudioCaptionAgent] No SRT beside MP4**
   - Category: `captions`
   - Location: `dist/FunctionIntuitive/FunctionIntuitive.srt`
   - Detail: `dist/FunctionIntuitive/FunctionIntuitive.srt` does not exist.
...
2. **[AudioCaptionAgent] No audio stream**
   - Category: `audio`
   - Location: `dist/FunctionIntuitive/FunctionIntuitive.mp4`
...
3. **[RenderMetadataAgent] Metadata summary**
   - Category: `render`
   - Location: `dist/FunctionIntuitive/FunctionIntuitive.mp4`
   - Detail: Duration 106.5s, resolution 854x480, frame rate 15.00 fps.
...
6. **[SourceScriptAgent] Manual narration pacing detected**
   - Category: `sync`
   - Location: `scenes/function_intuitive_fr/function_intuitive_scene.py`
...
7. **[SourceScriptAgent] Scene class found**
   - Category: `source`
   - Location: `scenes/function_intuitive_fr/function_intuitive_scene.py:34`
   - Detail: `FunctionIntuitive` is defined.
   - Fix: No action needed.

8. **[VisualFrameAgent] Contact sheet generated**
   - Category: `visual`
   - Location: `reports/video_audits/FunctionIntuitive_audit_frames/contact_sheet.png`
...
```bash
./.venv/bin/python -m py_compile scenes/function_intuitive_fr/function_intuitive_scene.py
MANIM_DISABLE_VOICEOVER=1 ./scripts/render.sh scenes/function_intuitive_fr/function_intuitive_scene.py FunctionIntuitive ql
./.venv/bin/python scripts/audit_video.py --scene scenes/function_intuitive_fr/function_intuitive_scene.py --class FunctionIntuitive --video dist/FunctionIntuitive/FunctionIntuitive.mp4 --out reports/video_audits/FunctionIntuitive_audit.md --silent-preview
```
