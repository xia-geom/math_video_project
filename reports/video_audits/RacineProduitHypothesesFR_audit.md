...
Generated: 2026-07-31 00:11:44

## Executive Summary

- Scene: `scenes/erreurs_frequentes_fr/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr_scene.py`
- Video: `dist/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr.mp4`
...
1. **[AudioCaptionAgent] No SRT beside MP4**
   - Category: `captions`
   - Location: `dist/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr.srt`
   - Detail: `dist/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr.srt` does not exist.
...
2. **[AudioCaptionAgent] No audio stream**
   - Category: `audio`
   - Location: `dist/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr.mp4`
...
6. **[SourceScriptAgent] Scene class found**
   - Category: `source`
   - Location: `scenes/erreurs_frequentes_fr/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr_scene.py:53`
...
```bash
./.venv/bin/python -m py_compile scenes/erreurs_frequentes_fr/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr_scene.py
MANIM_DISABLE_VOICEOVER=1 ./scripts/render.sh scenes/erreurs_frequentes_fr/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr_scene.py RacineProduitHypothesesFR ql
./.venv/bin/python scripts/audit_video.py --scene scenes/erreurs_frequentes_fr/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr_scene.py --class RacineProduitHypothesesFR --video dist/02_racine_d_un_produit_fr/02_racine_d_un_produit_fr.mp4 --out reports/video_audits/RacineProduitHypothesesFR_audit.md --silent-preview
```
