...
Generated: 2026-07-17 16:30:08

## Executive Summary

- Scene: `scenes/algebre_et_polynomes_fr/07_completer_le_carre_fr/07_completer_le_carre_fr_scene.py`
...
1. **[AudioCaptionAgent] Audio summary**
   ...
   - Detail: Audio duration 226.2s, average -26.0 dBFS, peak -6.9 dBFS.
...
5. **[SourceScriptAgent] Manual narration pacing detected**
   - Category: `sync`
   - Location: `scenes/algebre_et_polynomes_fr/07_completer_le_carre_fr/07_completer_le_carre_fr_scene.py`
...
6. **[SourceScriptAgent] Scene class found**
   - Category: `source`
   - Location: `scenes/algebre_et_polynomes_fr/07_completer_le_carre_fr/07_completer_le_carre_fr_scene.py:41`
...
```bash
./.venv/bin/python -m py_compile scenes/algebre_et_polynomes_fr/07_completer_le_carre_fr/07_completer_le_carre_fr_scene.py
MANIM_DISABLE_VOICEOVER=1 ./scripts/render.sh scenes/algebre_et_polynomes_fr/07_completer_le_carre_fr/07_completer_le_carre_fr_scene.py CompleteTheSquare ql
./.venv/bin/python scripts/audit_video.py --scene scenes/algebre_et_polynomes_fr/07_completer_le_carre_fr/07_completer_le_carre_fr_scene.py --class CompleteTheSquare --video dist/CompleteTheSquare/CompleteTheSquare.mp4 --out reports/video_audits/CompleteTheSquare_audit.md --silent-preview
```
