...
class EliminationVariablesFR(TeachingScene):
    def construct(self):
        ...
        self.new_page('Soustraire deux fois la deuxième équation', a, b, c, gap=0.35)
        ...
        self.new_page('Une solution : l’intersection des droites', diagram)
        ...
        self.new_page('Pourquoi ces opérations sont-elles permises ?', a, b, c)
        ...
        self.new_page('À vous : quelle addition simplifie le système ?', a, b)
