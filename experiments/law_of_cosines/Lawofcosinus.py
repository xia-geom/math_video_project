...
script = [
    # [0]
    "Considérons un triangle dont deux côtés mesurent A et B, et où l’angle entre eux est gamma.",
    "La hauteur du triangle fait partie de <bookmark mark='triangle'/>ce triangle rectangle dont l’hypoténuse est B, et elle est opposée à gamma ; <bookmark mark='length'/>sa longueur vaut donc B sinus gamma.",
    "Ce segment fait partie du même triangle rectangle et il est adjacent à gamma ; <bookmark mark='length'/>sa longueur vaut donc B cosinus gamma.",
    "Ce segment, ajouté à B cosinus gamma, est égal à A ; <bookmark mark='length'/>sa longueur vaut donc A moins B cosinus gamma.",
    "Ce segment est <bookmark mark='hl'/>le troisième côté du triangle ; <bookmark mark='length'/>sa longueur vaut donc C.",
    # [5]
    "On peut calculer C avec le théorème de Pythagore ; en simplifiant, on obtient : C au carré égale A au carré plus B au carré moins 2 A B cosinus gamma.",
    "En fait, cette formule est valable pour n’importe quel triangle : vous pouvez mettre la vidéo sur pause et la vérifier vous-même."
]
